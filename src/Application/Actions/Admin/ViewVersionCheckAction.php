...
class ViewVersionCheckAction extends AdminAction
{
    ...
    protected function action(): Response
    {
        ...
        if ($contents == false) {
            $versionClass = 'error';
            $versionAnswer = sprintf(getMessageString('admin_new_version_error'), APP_VERSION);
        } else {
            ...
            if ($result === -1) {
                ...
                $msg1 = sprintf(getMessageString('admin_new_version'), $versionInfo->{'version'}, APP_VERSION);
                ...
                $versionClass = '';
                $versionAnswer = sprintf(getMessageString('admin_no_new_version'), APP_VERSION);
            }
        }
