...
class AppConstants
{
    ...
    public const REMEMBER_COOKIE_DURATION = 'remember_cookie_duration';
    # if true then auth cookies can be used
    public const REMEMBER_COOKIE_ENABLED = 'remember_cookie_enabled';
    # encryption key for cookies
    public const REMEMBER_COOKIE_KEY = 'remember_cookie_key';
    # if true ascii transliteration will be used for searches
    public const SEARCH_ASCII_TRANSLITERATION = 'search_ascii_transliteration';
